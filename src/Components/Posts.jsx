          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              <div className="flex items-center mb-4">
                <div className="w-10 h-10 bg-blue-500 rounded-full flex items-center justify-center text-white font-bold text-xl">M</div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="services.html" className="text-gray-400 hover:text-white">Services</a></li>
                <li><a href="ai-chat.html" className="text-gray-400 hover:text-white">AI Chat</a></li>
                <li><a href="posts.html" className="text-gray-400 hover:text-white">Community</a></li>
